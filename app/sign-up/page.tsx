...
export default function SignUpPage() {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-500 to-green-600 p-12 text-white">
        <div className="flex flex-col justify-center">
          ...
          <p className="mb-12 text-lg text-green-100">
            Join thousands of students who are studying smarter, not harder, with our AI-powered assistant.
          </p>

          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-green-600 font-bold">
                1
              </div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 text-center">
            ...
            <Link href="/sign-in" className="text-sm font-medium text-green-600 hover:text-green-500">
              Sign in
            </Link>
          </div>
        </div>
